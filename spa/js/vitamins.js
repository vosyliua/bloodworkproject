...
async function setPage (node){
    ...
    var num = 0
    var vitaminArray = ["Vitamin A","Vitamin B1","Vitamin B2","Vitamin B3","Vitamin B6","Vitamin B12","Vitamin C","Vitamin D","Vitamin E","Vitamin K","LDL CHOLESTEROL","HDL CHOLESTEROL","Calcium","Iron","Sodium","Zinc","Potassium","Magnesium"]
    var amountArray = []
    ...
    var recommended = ["15-60","74-222","4-24","0.5-8.45","5 - 25","205-678","0.6-2", "20-40","5.5-17","0.2-3.2","100-129","40", "8.5-10.2","60-170","135-145","10.1–20.2"," 3.6-5.2","1.7-2.2"]
    ...
    if(vitArray[4] <= 5  || vitArray[5]>= 25){
        results.push("X")
    }else{
        results.push("V")
    }
    if(vitArray[5] <= 205  || vitArray[6]>= 678){
        results.push("X")
    }else{
        results.push("V")
    }
    if(vitArray[6] <= 0.6  || vitArray[7]>= 2){
        results.push("X")
    }else{
        results.push("V")
    }
    if(vitArray[7] <= 20  || vitArray[8]>= 40){
        results.push("X")
    }else{
        results.push("V")
    }
    if(vitArray[8] <= 5.5  || vitArray[9]>= 17){
        results.push("X")
    }else{
        results.push("V")
    }
    if(vitArray[9] <= 0.2  || vitArray[10]>= 3.2){
        results.push("X")
    }else{
        results.push("V")
    }
    if(vitArray[10] <= 100  || vitArray[11]>= 129){
        results.push("X")
    }else{
        results.push("V")
    }
    if(vitArray[11] <= 400){
        ...
        results.push("V")
    }if(vitArray[12] <= 8.5  || vitArray[13]>= 10.2){
      results.push("X")
    }else{
      results.push("V")
    }if(vitArray[13] <= 60  || vitArray[14]>= 170){
      results.push("X")
    }else{
      results.push("V")
    }if(vitArray[14] <= 135  || vitArray[15]>= 145){
      results.push("X")
    }else{
      results.push("V")
    }if(vitArray[15] <= 10.1  || vitArray[16]>= 20.2){
      results.push("X")
    }else{
      results.push("V")
    }if(vitArray[16] <= 3.6 ){
